...
extension SignUpPresenterTests {
    ...
    func makeSignUpViewModel(name: String? = "any_name", email: String? =  "any_email@forms.com", password: String? = "secret", passwordConfirmation: String? = "secret") -> SignUpViewModel {
